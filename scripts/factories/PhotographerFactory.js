...
export class PhotographerFactory {
  ...
  async displayProfile() {
    ...
    // Ajouter le nom du photographe dans le dialog de contact
    ...
    priceElement.setAttribute(
      "aria-label",
      `Tarif du photographe : ${photographer.price} euros par jour`
    );
      ...
      likeButton.addEventListener("click", () => {
        ...
        if (likedMedia.liked) {
          ...
          likeButton.setAttribute(
            "aria-label",
            "Cliquer pour retirer le j'aime"
          );
        }
  ...
  displayTotalLikes(medias) {
    ...
    likesSumWidget.setAttribute(
      "aria-label",
      `Nombre total des likes ${likesSum}`
    );
  ...
  createPhotographerCard(photographer) {
    ...
    location.setAttribute(
      "aria-label",
      `adresse : ${photographer.city}, ${photographer.country}`
    );
